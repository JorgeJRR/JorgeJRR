...
I have a particular fondness for **Platformers** and **Action/Adventure** games.
...
* **Game Engines:** Unity Engine (Primary), GameMaker Studio (Basic Knowledge)
* **Version Control:** Git
* **Development Tools:**
    * Visual Studio
    * GitHub Desktop
    * Krita (Basic image and sprite editing)

#### My Specialization: Unity UI Programming
...
* **Description:** This project showcases a comprehensive dialogue management system, demonstrating effective state handling, text presentation, and interaction flows.
...
* **Description:** This system provides a foundational framework for managing in-game items, inventory slots, and item interactions.
...
* **Description:** This project features a clean and interactive main menu with customizable settings options, showcasing best practices in UI navigation and responsiveness.
* **Key Contributions:** Focused on delivering a highly polished user experience with smooth transitions and clear visual feedback.
* **Challenges Overcome:** Ensuring cross-platform compatibility for UI elements and optimizing performance for various resolutions.
...
[![GitHub Stats](https://github-readme-stats.vercel.app/api?username=JorgeJRR&show_icons=true&theme=dark&hide_border=true)](https://github.com/anuraghazra/github-readme-stats)
...
* **Email:** jorgejesusromero@gmail.com
